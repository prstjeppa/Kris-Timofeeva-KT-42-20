...
namespace kriskt_42_20.Controllers
{
    ...
    public class PrepodController : ControllerBase
    {
        ...
        public IActionResult CreateKafedra([FromBody] kriskt_42_20.Models.Kafedra kafedra)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
        ...
        public IActionResult DeleteKafedra(string kafedraName, kriskt_42_20.Models.Kafedra updatedKafedra)
        {
            var existingKafedra = _context.Kafedra.FirstOrDefault(g => g.KafedraName == kafedraName);
